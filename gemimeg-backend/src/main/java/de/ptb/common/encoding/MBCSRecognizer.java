...
public abstract class MBCSRecognizer extends CharsetRecognizer {
  ...
  abstract static class EUC extends MBCSRecognizer {
  ...
  static class GB18030 extends MBCSRecognizer {
